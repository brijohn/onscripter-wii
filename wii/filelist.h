...
extern const u8		bg_list_selection_png[];
extern const u32	bg_list_selection_png_size;

extern const u8		bg_list_selection_entry_png[];
extern const u32	bg_list_selection_entry_png_size;
